const accessKey='-Y9ymWkbTSHxOGX5yo9gd_8QNJRqaudOYeo4TDpwqsU';
...
const fetchImages = async (query, pageNo) => {
    ...
    if (data.results.length > 0) {
        data.results.forEach(picture => {
            ...
            imageElement.innerHTML = `<img src="${picture.urls.regular}"/>`;
            ...
            overlayText.innerText = `${picture.alt_description}`;
